...
overview:
  ...
  guidelines: 準備中
  activities: 定例ミーティング、各種企画（芋煮会、山形旅行、山形関連イベントでのボランティア、外語祭参加など）
operations:
  executiveMembers:
    - 執行代は不定
  organization: 書類上の代表はいるものの、メンバー全員で協力して運営しています。
membership:
  memberCount: 18
  yearDistribution:
    - '1年生: 2人'
...
schedule:
  ...
  annualPlan:
    - 昨年度の実績
    - 4月　アンテナショップ巡り＠銀座・有楽町・高円寺
    - 6月　初夏の芋煮会＠府中市白糸台文化センター
    - 6月　やまがたフルーツ150周年記念イベントボランティア＠国連大学
    - 9月　山形旅行（有志のみ）
    - 11月　外語祭への出展
    - 12月　冬の芋煮会＠府中市紅葉丘文化センター
    - 1月　卒業生送別会
    - 3月　山形市麺フェスボランティア@池袋
recruitment:
  applicationDeadline: ''
  ...
  annualFee: 無し。ただし、企画参加時には実費負担あり。
  hasSelection: false
  targetAudience: 全学年（学部生、院生、留学生など誰でも）
  contact:
    facebook: ''
