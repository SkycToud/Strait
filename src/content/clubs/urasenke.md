...
overview:
  philosophy: 楽しく、仲良く、日本の和の心を学ぶ
  guidelines: 準備中
  activities: 先生に教えていただきながら様々なお手前のお稽古をします。定期的にお茶会を行ったり、夏休みには合宿に行ったり、様々なイベントがあります！
operations:
  executiveMembers:
    - 部長:三年生　各イベントの係:主に二年生
  organization: 部長、会計、渉内、渉外、広報、お菓子の用意、先生への連絡など
membership:
  memberCount: 8
  yearDistribution:
    - '1年生: 2人'
...
recruitment:
  applicationDeadline: ''
  appeal: 先輩後輩の仲がとても良いです。初心者からでも始められます。
  challenges: お茶巾やタオルの洗濯
  welcomeEvents: 4/14、4/28に和室で体験・見学会を行う予定です。
  annualFee: 毎月2000円
  hasSelection: false
  targetAudience: 誰でも。一年生〜院生まで！初心者歓迎！留学生にもおすすめ！
  contact:
    facebook: ''
    website: ''
    media: ''
