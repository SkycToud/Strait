...
overview:
  philosophy: 誰もがきちんとした場所で暮らせる世界
  guidelines: 準備中
  activities: '海外:主に東南アジアへ学生チームを派遣し建築ボランティアを行います。国内:子ども食堂、援農合宿、清掃活動などを通して地域密着型のボランティアを実現します。'
operations:
  executiveMembers:
    - '2年生'
  organization: 代表、副代表、会計、広報(各1名)
membership:
  memberCount: 13
  yearDistribution:
    - '2年生: 8人'
...
recruitment:
  ...
  challenges: 海外派遣のボランティアは基本私費になるため、費用がネックだという声が多くあります。スポンサーシップへの応募など、少しでも負担を減らせるよう奮闘中です！
  applicationFlow: |-
    定期ミーティング・4/8昼休み,4/22昼休み・206-1・アポなしOK
    オンライン新歓・20-21:00
  ...
  welcomeEvents: |-
    ...
    オンライン新歓・20-21:00
    4/8,12,15,19,22,26・ZOOM・インスタのDMでご連絡ください！
  annualFee: '2000円(入サー時のみ、年会費ではございません)'
  hasSelection: false
  targetAudience: 全学年
  contact:
    facebook: ''
